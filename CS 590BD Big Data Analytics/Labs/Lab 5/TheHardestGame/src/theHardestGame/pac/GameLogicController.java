...
public class GameLogicController extends BaseGameActivity /* implements IAccelerometerListener */ {
	...
	/**
	 * CHANGE THIS? GET FROM SENSORTAG
	...
	*/
	...
	public class ConnectionServiceReceiver extends BroadcastReceiver {
		public static final String PROCESS_RESPONSE = "theHardestGame.pac.intent.action.PROCESS_RESPONSE";
		@Override
		public void onReceive(Context context, Intent intent) {
			String X = intent.getStringExtra(ConnectionService.X);
			String Y = intent.getStringExtra(ConnectionService.Y);

			mGravityX = Float.parseFloat(Y) * 2;
			mGravityY = Float.parseFloat(X) * 2;
			if(mGravityX > con)
				mGravityX = con;
			if(mGravityY > con)
				mGravityY = con;
	...
	/**
	 * MAYBE REPLACE W/ GESTURE RECOGNITION
	 */
	@Override
